  ...
  const handleSubmit = (e) => {
    ...
    startTransition(async () => {
      try {
        ...
        // Convert single category to array and stringify
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            disabled={isPending}
            className="w-full p-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-[#7050ff] outline-none disabled:opacity-50 disabled:bg-gray-100"
            required
            minLength={3}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            disabled={isPending}
            className="w-full p-3 rounded-lg border border-gray-300 bg-white text-gray-900 outline-none disabled:opacity-50"
            required
          />
          {blogPreview && (
            <img
        ...
        <button
          type="submit"
          disabled={isPending}
          className="w-full bg-[#7050ff] text-white p-3 rounded-lg hover:bg-[#5a3de0] transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
        >
